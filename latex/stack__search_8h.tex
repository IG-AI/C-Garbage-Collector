...
\index{stack\+\_\+find\+\_\+next\+\_\+ptr@{stack\+\_\+find\+\_\+next\+\_\+ptr}!stack\+\_\+search.\+h@{stack\+\_\+search.\+h}}
...
When calling the function use; \+\_\+\+\_\+builtin\+\_\+frame\+\_\+address(n); To get a pointer to the start of a scopes memory on stack. $<$n$>$ specifies what scope. 0 is the current, 1 the one above. On S\+P\+A\+R\+C with Sun C Compiler this doesn\textquotesingle{}t work so another method is needed.

extern char $\ast$$\ast$environ; To get the bottom of the programs\textquotesingle{} stack. When refering to it use something similar to\+: void $\ast$stack\+\_\+bottom = (void $\ast$)$\ast$environ; void $\ast$pointer = stack\+\_\+find\+\_\+next\+\_\+ptr(\&stack\+\_\+bottom, stack\+\_\+top, heap\+\_\+start, heap\+\_\+end); 